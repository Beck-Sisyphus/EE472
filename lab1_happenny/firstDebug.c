...
main(void)
{
    ...
    // Needs 10 spots for 10 digits 0-9
    char myData[10];							//  declare a character array
    ...
    while(TRUE)
    {
      ...
      // Should loop 10 times to go through full myData
      for (i = 0; i <= 9; i++)
      {
        // Adds ascii code for zero to i to offset to digits
