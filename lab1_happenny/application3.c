...
//*****************************************************************************
//
// Print AC then BD for ~1 second each
//
//*****************************************************************************
int
main(void)
{
    ...
    while(TRUE)
    {
      ...
      // Show 'AC' on screen for ~1 second
      display('A', 0, 50, 54);
      display('C', 8000, 56, 54);
      
      // Clear the screen and keep blank for ~1 second
      clearScreen(8000);

      // Show 'BD' on screen for ~2 seconds      
      display('B', 0, 65, 54);
      display('D', 16000, 71, 54);
      
      // Clear the screen and keep blank for ~2 seconds
      clearScreen(16000);
